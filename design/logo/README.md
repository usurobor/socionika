# socionika — medallion CAD generator

Practical socionika: the medallion logo as a parametric CAD artifact.

## Status

This subdirectory delivers a working socionics medallion CAD generator
per issues #1, #2, #3, and #5:
...
Run tests (from this directory): `python -m unittest discover tests`.

Run from repo root: `cd design/logo && python -m unittest discover tests`.
